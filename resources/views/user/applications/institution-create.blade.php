...
document.querySelectorAll('.file-input').forEach(input => {
    const parent = input.closest('.col-md-12');
    ...
    input.addEventListener('change', function () {
        ...
        Array.from(this.files).forEach(file => {
            ...
            // If invalid → DO NOT add to list
            if (errorMsg) {
                invalidMessages.push(errorMsg);
                return;
            }
...
<hr>
    ...
    <!-- File Error Modal -->
<div class="modal fade" id="fileErrorModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p id="fileErrorMessage" style="white-space: pre-line;"></p>
            </div>

            <div class="modal-footer">
                <button class="btn btn-danger" data-bs-dismiss="modal">Okay, I understand</button>
            </div>
...
document.getElementById('review-btn').addEventListener('click', function () {
    ...
    attachmentInputs.forEach(input => {
        if (input.files.length > 0) {
            anyFiles = true;
            const label = input.closest('.col-md-12').querySelector('label').innerText;
